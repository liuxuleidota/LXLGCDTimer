//
//  LXLGCDTimerManager.m
//  LXLGCDTimer
//
//  Created by levi 2018/10/19.
//  Copyright levi.liu. All rights reserved.
//

#import "LXLGCDTimerManager.h"

@interface LXLGCDTimerManager ()
...
@implementation LXLGCDTimerManager

#pragma mark - Public Method

// 单例
+ (LXLGCDTimerManager *)sharedInstance
{
    static LXLGCDTimerManager *_LXLGCDTimerManager = nil;
    
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken,^{
        _LXLGCDTimerManager = [[LXLGCDTimerManager alloc] init];
    });
    
    return _LXLGCDTimerManager;
}
